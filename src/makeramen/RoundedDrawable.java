...
//        RectF rectR = new RectF(mDrawableRect.width() / 2, 2, mDrawableRect.width() ,mDrawableRect.height()  - 2);
        RectF rectB = new RectF(mBorderWidth, mDrawableRect.height() -15, mDrawableRect.width(), mDrawableRect.height());
//        RectF rectL = new RectF(0, 2, mDrawableRect.width()  / 2, mDrawableRect.height() - 2);
//        canvas.drawRect(rectR, mBitmapPaint);
        canvas.drawRect(rectB, mBitmapPaint);
//        canvas.drawRect(rectL, mBitmapPaint);
      } else {
